...
function Navbar() {
  ...
  return (
    <div className="flex items-center justify-between p-2 bg-gray-100 shadow-md rounded-2xl my-4 ml-20 font-Montserrat">
  ...
  <input
    ...
    className="pl-10 border bg-white rounded-3xl w-full py-1 focus:outline-none focus:ring-2 focus:ring-blue-400"
  />
</div>
